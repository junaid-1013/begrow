export const Hero = () => {
    return (
        <section id="home" className="bg-white">
            <div className="grid px-8 md:px-12 xl:px-32 lg:px-20 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-x text-justify">
